        ...
        <div className="past-analyses">
          {pastAnalyses.length > 0 ? (
            pastAnalyses.map(analysis => {
              const confidence = getConfidenceLevel(analysis.result.confidence);
                ...
                <div key={analysis.id} className={`analysis-card ${theme}`}>
                  ...
                  <div className="analysis-content">
                    <div className="analysis-header">
                      <h3 className="condition-name">{analysis.result.name}</h3>
                      
                      <div className={`confidence-badge ${confidence.class}`}>
                        <span className="confidence-score">{analysis.result.confidence}%</span>
                      </div>
                    </div>
